...
PUC Minas - Ciencia da Computacao     Nome: Quicksort
...
public class Quicksort
{
    ...
    public static String quicksort(int esqInicial, int dirInicial, String[] stringArray, Lista institutionsList, String lastResult)
    {
    ...
    public static String quicksort(String[] stringArray, Lista institutionsList)
    {
        String result = "0\t0";
