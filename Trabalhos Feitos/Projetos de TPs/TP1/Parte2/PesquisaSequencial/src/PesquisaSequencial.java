...
PUC Minas - Ciencia da Computacao     Nome: PesquisaSequencial

Autor: Axell Brendow Batista Moreira  Matricula: 631822

Versao:  1.0                          Data: 05/09/2018
...
{
    /**
     * Percorre um arranjo checando se cada um de seus elementos e' igual 'a chave.
     * A funcao retornara' quantas comparacoes foram feitas no processo.
     * Porem, se a chave tiver sido encontrada, esse numero de comparacoes estara'
     * com o sinal trocado, ou seja, negativo.
     * 
     * @param key elemento a ser procurado
     ...
     * trocado, ou seja, negativo.
     */
    
    public static int doSequentialSearch(Object key, Object[] array)
    {
        int numberOfComparions = 0;
        
        if (array == null || key == null)
        {
            AxellIO.println("[PesquisaSequencial]: Arranjo ou chave nulos. - doSequentialSearch(Object, Object[])");
        }
        ...
        else
        {
            for (int i = 0; i < array.length; i++)
            {
                ...
                {
                    numberOfComparions *= -1;
                    i = array.length;
                }
            }
        }
        
        return numberOfComparions;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        {
            searchComparisons = doSequentialSearch(sigla, listaDeSiglas.copyArray());
        ...
        AxellIO.setPrintStream("matrícula_sequencial.txt");
