...
PUC Minas - Ciencia da Computacao     Nome: OrdenacaoPorInsercao
...
public class OrdenacaoPorInsercao
{
    ...
    public static String ordenateInstitutionsByCode(Lista institutionsList)
    {
        int size = institutionsList.size();
        ...
        for (int i = 1; i < size; i++)
        {
            ...
            for (j = i - 1; elementToInsert < codesArray[j] && j >= 0; j--, numberOfComparisons++)
            {
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        ordenationResult = ordenateInstitutionsByCode(listaDeInstituicoes).split("\t");
