...
PUC Minas - Ciencia da Computacao     Nome: OrdenacaoPorSelecao
...
public class OrdenacaoPorSelecao
{
    ...
    public static String getIndexOfLowestElementStartingFrom(int start, int[] intArray)
    {
        int indexOfLowestElement = start;
        int lowestElement = intArray[start];
        int currentElement;
        int numberOfComparisons = 0;
        
        for (int i = start + 1; i < intArray.length; i++, numberOfComparisons++)
        {
        ...
        return indexOfLowestElement + "\t" + numberOfComparisons;
    }
    ...
    public static String ordenateInstitutionsByCode(Lista institutionsList)
    {
        ...
        for (int i = 0; i < size; i++, numberOfMovimentations += 3)
        {
            resultOfSearchForLowestElement = getIndexOfLowestElementStartingFrom(i, codesArray).split("\t");
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        AxellIO.setPrintStream("matrícula_selecao.txt");
