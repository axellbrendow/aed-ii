...
class LogicOperation extends Operation
{
    ...
    public Boolean recursiveAnd(int operandIndex, int numberOfOperands)
    {
        Boolean result = true;
        
        if (operandIndex < numberOfOperands)
        {
            result = AxellIO.getBoolean(getOperand(operandIndex)) && recursiveAnd(operandIndex + 1, numberOfOperands);
        }
        
        return result;
    }
    
    public Boolean recursiveOr(int operandIndex, int numberOfOperands)
    {
        Boolean result = false;
        
        if (operandIndex < numberOfOperands)
        {
            result = AxellIO.getBoolean(getOperand(operandIndex)) || recursiveOr(operandIndex + 1, numberOfOperands);
        }
    ...
    public Boolean doOperation()
    {
        ...
        else
        {
            ...
            if (operatorSymbol.equals("and"))
            {
                ...
                {
                    result = recursiveAnd(0, getNumberOfOperands());
            ...
            else if (operatorSymbol.equals("or"))
            {
                ...
                {
                    result = recursiveOr(0, getNumberOfOperands());
...
PUC Minas - Ciencia da Computacao     Nome: AlgebraBooleanaRecursiva
