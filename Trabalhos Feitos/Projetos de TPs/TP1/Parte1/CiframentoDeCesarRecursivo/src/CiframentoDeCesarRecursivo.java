...
class MyString extends ErrorClass
{
    ...
    private String moveStr(int rotation, int charIndex, int strLength)
    {
        String movedStr = "";
        
        if (charIndex < strLength)
        {
            movedStr += (char) (getCharAt(charIndex) + rotation) + moveStr(rotation, charIndex + 1, strLength);
        }
...
PUC Minas - Ciencia da Computacao     Nome: CiframentoDeCesarRecursivo
