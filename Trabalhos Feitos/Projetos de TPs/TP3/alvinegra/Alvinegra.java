...
public class Alvinegra {
	...
	public void inserir(int elemento) throws Exception {
      No bisavo = null, avo = null, pai = null, i = null;
      ...
      if(raiz == null){
         ...
         //Se a arvore tem um elemento 
         if (raiz.esq == null && raiz.dir == null){
            pai = raiz;

         //Se a arvore tem dois elementos (raiz e dir)
         } else if (raiz.esq == null){
            avo = raiz;
            pai = raiz.dir;

         //Se a arvore tem dois elementos (raiz e esq)
         } else if (raiz.dir == null){
            avo = raiz;
            pai = raiz.esq;

         //Se a arvore tem tres ou mais elementos
         } else {
            i = raiz;
         }
         inserir(elemento, bisavo, avo, pai, i);
         raiz.cor = false;
      }
