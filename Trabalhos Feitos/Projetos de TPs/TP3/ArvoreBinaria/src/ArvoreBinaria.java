...
PUC Minas - Ciencia da Computacao     Nome: ArvoreBinaria
...
public class ArvoreBinaria
{
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        BinarySearchTree binaryTree = new BinarySearchTree(BinarySearchTree.TreeType.Strings);
        ...
        AxellIO.setPrintStream("matrícula_arvoreBinaria.txt");
