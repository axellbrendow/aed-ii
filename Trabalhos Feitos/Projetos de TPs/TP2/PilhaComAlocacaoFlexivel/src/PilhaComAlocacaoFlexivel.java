...
PUC Minas - Ciencia da Computacao     Nome: PilhaFlexivel
...
class Pilha extends SimpleList
{
    public Pilha()
    {
        super();
...
PUC Minas - Ciencia da Computacao     Nome: PilhaComAlocacaoFlexivel
...
public class PilhaComAlocacaoFlexivel
{
    ...
    {
        Pilha pilhaDeInstituicoes = new Pilha();
        ...
        while (lineNumber != null && lineNumber != 0)
        {
            ...
            pilhaDeInstituicoes.stackUp(new Instituicao(AxellIO.readLine("")) );
        ...
        for (int i = 0; i < numberOfCommands; i++)
        {
            ...
            if (commandOperands[0].charAt(0) == 'I')
            {
                ...
                pilhaDeInstituicoes.stackUp(instituicaoAtual);
            ...
            {
                AxellIO.println("(R) " + ( (Instituicao) pilhaDeInstituicoes.unstack() ).getNome());
            }
        }
        
        pilhaDeInstituicoes.printList();
    }
}
