...
class Queue
{
    ...
    public Cell getCellOnIndex(int index)
    {
        ...
        {
            AxellIO.println("[Queue]: Indice invalido. (index = " + index + ") - funcao getCellOnIndex(int)");
        }
    ...
    {
        if (getNumberOfElements() == 5) remove();
    ...
    {
        int numberOfElements = getNumberOfElements();
        Cell[] queueArray = new Cell[numberOfElements];
        
        for (int i = 0; i < numberOfElements; i++)
        {
            queueArray[i] = getCellOnIndex(i);
        }
...
PUC Minas - Ciencia da Computacao     Nome: FilaComAlocacaoFlexivel
...
public class FilaComAlocacaoFlexivel
{
    public static int getMeanOfDespesasDocentes(Queue filaCircularDeInstituicoes)
    {
        ...
        {
            Cell[] filaCircular = filaCircularDeInstituicoes.get();
            ...
            else
            {
                ...
                for (Cell cell : filaCircular)
                {
                    meanOfDespesasDocentes += Instituicao.convertToInstituicao(cell.getElement()).getDespesaDocente();
                }
    ...
    {
        Queue filaCircularDeInstituicoes = new Queue();
