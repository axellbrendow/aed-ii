...
PUC Minas - Ciencia da Computacao     Nome: ListaComAlocacaoFlexivel
...
public class ListaComAlocacaoFlexivel
{
    ...
    {
        SimpleList listaDeInstituicoes = new SimpleList();
        ...
        for (int i = 0; i < numberOfCommands; i++)
        {
            ...
            if (commandOperands[0].charAt(0) == 'I')
            {
                ...
                if (commandOperands[0].equals("I*"))
                {
                    // obtem a linha da instituicao no censo.dat
                    lineNumber = AxellIO.getint(commandOperands[2]);
                }
                ...
                if (commandOperands[0].equals("II"))
                {
                    listaDeInstituicoes.addOnStart(instituicaoAtual);
                }
                
                else if (commandOperands[0].equals("IF"))
                {
                    listaDeInstituicoes.addOnEnd(instituicaoAtual);
                }
                
                else if (commandOperands[0].equals("I*"))
                {
                    listaDeInstituicoes.add(instituicaoAtual, AxellIO.getint(commandOperands[1]));
                }
            ...
            {
                if (commandOperands[0].equals("RI"))
                {
                    AxellIO.println("(R) " + ( (Instituicao) listaDeInstituicoes.removeOnStart() ).getNome());
                }
                
                else if (commandOperands[0].equals("RF"))
                {
                    AxellIO.println("(R) " + ( (Instituicao) listaDeInstituicoes.removeOnEnd() ).getNome());
                }
                
                else if (commandOperands[0].equals("R*"))
                {
                    AxellIO.println("(R) " + ( (Instituicao) listaDeInstituicoes.remove( AxellIO.getint(commandOperands[1]) ) ).getNome() );
                }
            }
        }
